...
function ast_inject(ast, code, key) {
    ...
    var ws = {
        ...
        IfStatement: function (node) {
          // console.log('node', escodegen.generate(node.test))
...
function app() {
      // var code = "const hello = 'tree';";
      // var code = require('../lib/test-dep');
      ...
      console.log('generated: ' , escodegen.generate(ast));
}
