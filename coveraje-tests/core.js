var version = "0.2.4", // Keep in sync with `package.json` and `history.md`.
    defaultOptions = {
        beautify: false,
        colorizeShell: true,
        globals: "",
...
Coveraje.entryModule = function (m) {
    if (m == null) {
        return entryModule;
    } else if (entryModule === m) {
        entryModule = m.parent;
    }
};
